...
public class StoreManegement {
    ...
    void resupply(String[] items) {
       for (String item : items) {
        ...
        //nebo
//        storage.addAll(List.of(items));
//        //vzpis jmeno pridano na sklad - pro kazdou polozku
//        System.out.println("-------");
//        for (int i = 0; i < 4; i++) {
//            System.out.println("Bylo pridano: " + storage.get(storage.size()-1 - i));
//        }
    }
...
//       storage.removeAll(List.of(items));
        for (String item : items) {
            sell(item);
        }
    }
...
//        for (int i = 0; i < 10; i++) {
//            System.out.println(store.generateRandomNumber(0, 100));
//        }
    }
}
